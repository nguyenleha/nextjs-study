                ...
                <ul className="login_list">
                    <li className="login_item">
                        <div className="login_input_block">
                            ...
                            <TextInput placeholder={t('login:username')} type="text" value={valLogin.username} onChange={(value) => setValLogin((v) => ({ ...v, username: value }))} className="login_input" />
                        </div>
                    ...
                    <li className="login_item">
                        <div className="login_input_block">
                            ...
                            <TextInput placeholder={t('login:password')} type="password" value={valLogin.password} onChange={(value) => setValLogin((v) => ({ ...v, password: value }))} className="login_input" />
                        </div>
